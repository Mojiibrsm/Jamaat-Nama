        ...
        <div className="container mx-auto px-4 md:px-6">
          <Card className="max-w-4xl mx-auto animate-fade-in-up">
            ...
            <CardContent className="space-y-4 text-lg text-foreground/90 leading-relaxed">
              <p>
                "Jamaat Nama" একটি তথ্যভিত্তিক আর্কাইভ যা জামায়াত, শিবির এবং এর অঙ্গসংগঠনের কার্যক্রমের উপর ভিত্তি করে তৈরি। আমাদের লক্ষ্য হলো ঐতিহাসিক ঘটনা এবং তথ্যের একটি নির্ভুল এবং প্রমাণভিত্তিক সংগ্রহশালা তৈরি করা।
              </p>
              <p>
